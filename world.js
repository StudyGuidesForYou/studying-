...
export class World{
  ...
  createTerrain(detail=1){
    const geom=new THREE.PlaneGeometry(2000,2000,64*detail,64*detail);
  ...
  update(playerZ, dt){
    if(this.terrain) this.terrain.position.z=playerZ;
    if(this.road) this.road.position.z=playerZ;
  }
}
